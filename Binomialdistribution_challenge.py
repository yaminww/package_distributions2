...
# TODO: make a Binomial class that inherits from the Distribution class. Use the specifications below.
    ...
    # write a method to output the sum of two binomial distributions2. Assume both distributions2 have the same p value.
        ...
        # Hint: When adding two binomial distributions2, the p value remains the same
