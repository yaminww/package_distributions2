...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        # this code will generate self.mean, self.stdev, self.data
    ...
    def replace_stats_with_data(self):
        ...
        # TODO: The read_data_file() from the Generaldistribution class can read in a data file. Because the Binomaildistribution class inherits from the Generaldistribution class,
    ...
    def plot_bar_pdf(self):
        ...
        ax = fig.add_subplot()
        ax.bar(x, y)
        ax.set_title('Bar plot of PDF')
        ax.set_xlabel('number of success k')
    ...
    def __add__(self, other):
        ...
        """Function to add together two Binomial distributions2 with equal p
        ...
        # TODO: Define addition for two binomial distributions2. Assume that the
        #  p values of the two distributions2 are the same. The formula for
        #  summing two binomial distributions2 with different p values is more complicated,
        #  so you are only expected to implement the case for two distributions2 with equal p.
        ...
        #   When adding two binomial distributions2, the p value remains the same
        #   The new n value is the sum of the n values of the two distributions2.
    ...
    def __repr__(self):
        ...
        #
        #       with the values replaced by whatever the actual distributions2 values are
        #       The method should return a string in the expected format
        return f'mean: {self.mean: .3f}, standard deviation: {self.stdev: .3f}, p: {self.p: .3f}, n: {self.n: .3f}'
