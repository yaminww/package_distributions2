...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        super().__init__(self, mu=self.calculate_mean(), sigma=self.calculate_stdev())
    ...
    def replace_stats_with_data(self):
        ...
        self.p = math.sum(self.data) / len(self.data)
    ...
    def plot_bar(self):
        ...
        f = plt.hist(self.data)
        f.set_title('histogram')
        f.set_xlabel('value')
        f.set_ylabel('count')
    ...
    def pdf(self, k):
        ...
        return it.combinations(self.n, k) * math.power(self.p, k) * math.power(1 - self.p, self.n - k)
    ...
    def plot_bar_pdf(self):
        ...
        f1 = plt.bar(x=x, y=y)
        f1.set_label('bar plot of pdf')
        f1.set_xlabel('number of success')
